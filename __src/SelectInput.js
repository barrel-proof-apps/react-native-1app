...
export default  class Progresso extends Component {
 ...
 if(this.props.decorationColor){
    ...
    return (
      <View style={style}>
        <TouchableHighlight disabled={this.props.disabled} style={{
            flex:1,
            // backgroundColor:"#ccc",
            // height:30,
            alignSelf:"stretch"
          ...
          <View style={ {
            ...
            {this.props.label ?(
              <Text style={[{fontSize:11,padding:0,margin:0, marginBottom:3,color:style.borderBottomColor}  ]} >
                {this.props.label}
              </Text>
            ):null}
            <Text style={{
        ...
        <Modal
          ...
          <SelectInputList activity={this} first={this.props.first}  onChange={ (value,data,index)=>{
  ...
  class SelectInputList extends Component {
    ...
    row_listview_1(rowData , sectionID, rowID) {
      ...
      // console.log(rowData);
      return (
        <TouchableHighlight style={{backgroundColor:cor,margin:2}}  underlayColor = 'rgba(224,224,224,1)'  onPress={() =>{
            if (this.props.onChange) {
    ...
    render() {
      ...
      return (
        ...
        <View style={{flexDirection:"column",flex:1,alignSelf:"stretch", backgroundColor:"rgba(0,0,0,0.8)"}}>
