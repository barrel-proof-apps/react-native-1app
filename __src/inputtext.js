...
export default class ApiTextInput extends Component {
  ...
  render() {
    ...
    if(this.props.disabled){
      return(
        <View  style={[this.styles.view,this.styles.boxDisable]} >
          {this.props.label ?(
          ...
          <Text  style={[this.styles.text,this.styles.styleInput]}    >
            {this.state.text}
          </Text>
        </View>
      );
    ...
    return (
      <View  style={[this.styles.view,this.styles.box]} >
        {this.props.label ?(
          <Text style={[this.styles.label,{backgroundColor:"rgba(0,0,0,0)"}]} >
            {this.props.label   }
          </Text>
        ):null}

        <TextInput  placeholder={this.props.placeholder} onFocus={this.props.onFocus}  secureTextEntry={this.props.secureTextEntry}
