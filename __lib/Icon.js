...
export default class Icon extends Component {
  ...
  make(state) {
    ...
    if (this.props.fromFontFamily == "Material Design Icons") {
      ...
      this.Icon = createIconSet(glyphMap, "Material Design Icons", "materialdesignicons-webfont.ttf");
    } else {
      var glyphMap = {
        [state.icon]: parseInt(Icons[state.icon], 16)
      };
      this.Icon = createIconSet(glyphMap, "Material Icons", "MaterialIcons.ttf");
    }
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(this.Icon, _extends({}, this.props, {
        ref: "icon",
